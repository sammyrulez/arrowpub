Arrowpub::Application.routes.draw do
  ...
  get "dashboard/stats_count_pie"
   get "dashboard/stats_trend_lines"
  ...
  resources :shooting_ranges do
  	...
  	resources :shooting_sessions do
  	
  		resources :shooting_rounds
